...
class ResponseEventReadTest {
    @Test
    fun serializationEventReadResponse() {
        val jsonRequest = Json {
            prettyPrint = true
            serializersModule = SerializersModule {
                polymorphic(Message::class) {
                    subclass(ResponseEventRead::class, ResponseEventRead.serializer())
                }

            }
            classDiscriminator = "type"
        }
        val dto: Message = ResponseEventRead(
    ...
    "event": {
        ...
        assertEquals(dto, deserializedDto as ResponseEventRead)
    }
}