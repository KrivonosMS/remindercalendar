...
class ResponseEventCreateTest {
    @Test
    fun serializationEventCreateResponse() {
        val jsonRequest = Json {
            prettyPrint = true
            serializersModule = SerializersModule {
                polymorphic(Message::class) {
                    subclass(ResponseEventCreate::class, ResponseEventCreate.serializer())
                }

            }
            classDiscriminator = "type"
        }
        val dto: Message = ResponseEventCreate(
    ...
    "event": {
        ...
        assertEquals(dto, deserializedDto as ResponseEventCreate)
    }
}