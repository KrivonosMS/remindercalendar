...
class RequestEventReadTest {
    @Test
    fun serializationEventReadRequest() {
        val jsonRequest = Json {
            prettyPrint = true
            serializersModule = SerializersModule {
                polymorphic(Message::class) {
                    subclass(RequestEventRead::class, RequestEventRead.serializer())
                }
    ...
    "eventId": "event-id"
        ...
        assertEquals(dto, deserializedDto as RequestEventRead)
    }
}