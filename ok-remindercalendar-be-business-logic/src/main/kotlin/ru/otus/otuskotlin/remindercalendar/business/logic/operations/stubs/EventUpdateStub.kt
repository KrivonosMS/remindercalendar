package ru.otus.otuskotlin.remindercalendar.business.logic.operations.stubs
...
object EventUpdateStub : Operation<Context> by pipeline({
    startIf { stubCase != StubCase.NONE }

    operation {
        startIf { stubCase == StubCase.EVENT_UPDATE_SUCCESS }
        execute {
